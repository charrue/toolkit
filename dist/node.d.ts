...
declare const exec: (cmd: string, cwd?: string) => string;
...
export { AGENTS, Agent, Command, FindPathOptions, LOCKS, LocatePathOptions, agents, detectInstaller, exec, findUp, findUpMultiple, locatePath, toPath };
