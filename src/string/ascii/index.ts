 ...
 */
export const isControlCode = (key: number | string) => detectASCIICode(
  key,
  CONTROL_CODE_FIRST,
  CONTROL_CODE_LAST,
);
 ...
 */
export const isPrintableCode = (key: number | string) => detectASCIICode(
  key,
 ...
 * @param { number | string } key - ASCII字符或Unicode 码点
 */
export const isDigitCode = (key: number | string) => detectASCIICode(
  key,
  DIGIT_CODE_FIRST,
  DIGIT_CODE_LAST,
);
 ...
 * @param { number | string } key - ASCII字符或Unicode 码点
 */
export const isUpperCaseCode = (key: number | string) => detectASCIICode(
  key,
 ...
 * @param { number | string } key - ASCII字符或Unicode 码点
 */
export const isLowerCaseCode = (key: number | string) => detectASCIICode(
  key,
 ...
 * @param { number | string } key - ASCII字符或Unicode 码点
 */
export const isLetterCode = (key: number | string) => isUpperCaseCode(key) || isLowerCaseCode(key);

/**
 * @description 判断ASCII字符或Unicode码点是否是标点符号
 * @param { number | string } key - ASCII字符或Unicode 码点
 */
export const isPunctuation = (key: number | string) => isPrintableCode(key)
      && !isDigitCode(key)
      && !isLetterCode(key);
 ...
 * @param { number | string } key - ASCII字符或Unicode 码点
 */
export const isAlphanumeric = (key: number | string) => isLetterCode(key) || isDigitCode(key);
